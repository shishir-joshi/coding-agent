...
1. **Plan mode** – Separate exploration/planning phase from execution; agent proposes a concrete plan before making changes
2. **Agent mode** – Autonomous multi-step task execution with checkpoints and user approval gates
3. **Better search and indexing** – Add semantic search, file indexing, and AST-aware code navigation for large codebases